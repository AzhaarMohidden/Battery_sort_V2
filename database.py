...
print("Loading Array to memory.....")
temp_data = [[0 for i in range(5)] for j in range(3)]
Current_battery = [[0 for i in range(8)] for j in range(344)]
Old_battery = [[0 for i in range(8)] for j in range(344)]
...
# 20211214 re verified and removed battery '835'
...
# Dissable because unable to find the use case if found error please uncomment
...
def rem_tech4():
    ...
    for items in tech4:
        ...
        if(items != '000'):
            ...
            print(str(list_items) + str('. 009'+items))
...
def search():
    for battery in range(len(available_files)):
        ...
        if(available_files[battery] == tech4[0] or available_files[battery] == tech4[1] or available_files[battery] == tech4[2] ):
